<?php 
	...
	foreach ($category_item as $category) {
		...
		$col_list .= $this->Html->div('col', $num);
		$col_list .= $this->Html->div('col', $name);
		$col_list .= $this->Html->div('col', $link_edit);
		$col_list .= $this->Html->div('col', $link_del);
		
		$html_content .= $this->html->div('col-10', $col_list);
	}
